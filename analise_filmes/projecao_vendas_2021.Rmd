...
print("modelo final: modelo_final = lm(log(ingresso) ~ evn + google_trends + prop_cinema +genero, data = train)")
```
...
1. Valor de volume de buscas no Google Trends no ano de 2021: 2382 buscas aproximadamente.
2. Valor de EVN no ano de 2021: 45 para a expectativa de vida ao nascer.
